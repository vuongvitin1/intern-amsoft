        ...
        <Box className={classes.rootView}>
            <Box className={[classes.row, classes.rowPage, classes.spacingBottom].join(' ')}>
                ...
                <Box className={classes.row}>
                    <Button className={classes.btn} onClick={handleClickOpen} color="primary" variant="contained"><AssignmentReturnedIcon className={classes.icon}/> btn act</Button>
                    <Button className={classes.btn} onClick={handleClickOpen} color="primary" variant="contained"><AddBoxIcon className={classes.icon}/>btn act</Button>
                </Box>
            </Box>
